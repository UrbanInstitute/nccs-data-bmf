...
fiscal.codes <- data.frame( code=1:12, label=mos )
```
...
structure( list(code = c(3L, 1L, 2L, 6L, 7L, 8L, 9L), 
 ...
 affiliation = 
   c( "NONE", "NETWORK", "NETWORK", "GROUP-EXM", 
      "GROUP-EXM", "GROUP-EXM", "GROUP-EXM/NETWORK"),
 label = 
   c("INDEPENDENT (3)", "NETWORK-PARENT (1)", "NETWORK-INTERM (2)", 
     "GROUP-EXM-PARENT-REGULAR (6)", "GROUP-EXM-INTERM (7)", 
     "GROUP-EXM-PARENT-CHURCH (8)","SUBORDINATE (9)"),
  description = 
...
d$BMF_AFFILIATION_CODE[ d$BMF_GROUP_EXEMPT_NUM == 0 ] <- 3
...
```{r, echo=F}
level3.codes <-
structure(list(code = c("AR", "ED", "EN", "HE", "HS", "IN", "MO", 
"MR", "PB", "RE", "UN", "ZA", "ZB", "ZC", "ZD", "ZE", "ZF"), 
    label = c("Arts, culture and humanities(AR)", "Education(ED)", 
    "Environment/animals(EN)", "Health(HE)", "Human Services(HS)", 
    "International, foreign affairs(IN)", "Other mutual benefit(MO)", 
    "Pension and retirement funds(MR)", "Public, societal benefit(PB)", 
    "Religion related(RE)", "Unknown, unclassified(UN)", "Single organization support(ZA)", 
    "Fundraising within NTEE major group(ZB)", "Private grantmaking foundations(ZC)", 
    "Public foundations(ZD)", "General fundraising(ZE)", "Other Supporting Public Benefit(ZF)"
...
L3.labels <- 
c("Arts, culture and humanities(AR)", "Education(ED)", 
    "Environment/animals(EN)", "Health(HE)", "Human Services(HS)", 
    "International, foreign affairs(IN)", "Other mutual benefit(MO)", 
    "Pension and retirement funds(MR)", "Public, societal benefit(PB)", 
    "Religion related(RE)", "Unknown, unclassified(UN)", "Single organization support(ZA)", 
    "Fundraising within NTEE major group(ZB)", "Private grantmaking foundations(ZC)", 
    "Public foundations(ZD)", "General fundraising(ZE)", 
    "Other Supporting Public Benefit(ZF)" )
```
