...
|--------|------|--------|-------------|
| `ein` | char(11) | EIN | Employer Identification Number formatted as XX-XXXXXXX (canonical published key) |
| `ein_raw` | char | EIN | Source EIN as ingested (non-digits removed, **not** zero-padded) — lossy bare-integer surface (e.g. `000000004` → `4`); use `ein`/`ein_prefixed`/`EIN2` to join |
