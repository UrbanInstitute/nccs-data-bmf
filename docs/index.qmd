...
flowchart LR
    subgraph input["📥 Input"]
        A[("🗄️ S3 Bucket<br/>nccsdata/raw/bmf")]
    end
    ...
    subgraph final["✅ Final Outputs"]
        ...
        H[("Quality Report<br/>GitHub Pages")]
    end
...
5.  **Cuts** the ~60 transformed columns into a `.csv` data mart with an accompanying data dictionary
...
| `bmf_YYYY_MM_quality_report.html` | Human-readable quality report (published to GitHub Pages) |
...
│   └── [transform files]          # 18 transformation modules (24 functions)
├── data/
